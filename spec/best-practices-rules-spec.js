...
describe('Best practices rule', () => {
  ...
  describe('curly', () => {
    describe('for an if statement', () => {
      it('should report an error when curly braces are absent', () => {
        const text = source([
          'if (1)',
          '  2;'
        ])
    ...
    describe('for a case statement', () => {
      it('should not report a violation when curly braces are absent', () => {
        const text = source([
          'switch (1) {',
          'case 1:',
          '  2;',
    ...
    describe('for a default statement', () => {
      it('should not report a violation when curly braces are absent', () => {
        const text = source([
          'switch (1) {',
          'default:',
